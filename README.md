...
The client menu is grouped by Invoi client id (`128  CS  California Strategies`). Git worktrees are skipped. If one client has more than one checkout, a second repo menu appears. Unscoped folders without an Invoi id still show as themselves.
